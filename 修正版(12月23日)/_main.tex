\documentclass[submit,techrep,noauthor,dvipdfmx,twocolumn]{ipsj} % <= ipsj で！
...
% 本文．
% ==========================================
\input{soturonv1}  % 本文は muselab-sample.tex に書く
...
\bibliography{_main} % .bibファイルの名前（Zoteroからエクスポートして作る）
